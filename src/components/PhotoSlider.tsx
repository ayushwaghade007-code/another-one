...
const PhotoSlider = () => {
  ...
  const photos = [
  "https://plus.unsplash.com/premium_photo-1658506814710-931319e429b0?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D", // couple holding hands
  ...
  const captions = [
    "How our first adventure together will be",
    "Us in that magical sunset",
    "When you made me laugh so hard",
    "How our perfect day is gonna be",
  ...
  return (
    <div className="photo-slider-container">
      <h2 className="slider-title">Our Beautiful future Memories</h2>
